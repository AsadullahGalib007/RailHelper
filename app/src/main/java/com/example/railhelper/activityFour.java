...
public class activityFour extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Upload Status for Specific Stations");
        ...
        adapter = new ArrayAdapter<String>(activityFour.this, R.layout.sample_view, R.id.textId, menuItems);
        ...
        stations.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(true){
                    Intent intent = new Intent(activityFour.this,AddPostActivity.class);
